...
export default function Countdown({weddingDate}){
  ...
  const calc=()=>{const d=W-new Date();if(d<=0)return{d:0,h:0,m:0,s:0};return{d:Math.floor(d/86400000),h:Math.floor((d%86400000)/3600000),m:Math.floor((d%3600000)/60000),s:Math.floor((d%60000)/1000)}}
      ...
      <div className="cd-units">
        {[{v:t.d,l:'Gün'},{v:t.h,l:'Saat'},{v:t.m,l:'Dəq'},{v:t.s,l:'San'}].map(({v,l},i)=>(
          <React.Fragment key={l}>
            ...
            {i<3&&<span className="cd-col">:</span>}
          </React.Fragment>
        ))}
      </div>
    </div>
